...
for (const [mode, href, asset] of [
  ['counseling', '/data-core/counseling', 'work-visuals/story-v1.webp'],
  ['work', '/data-core/work', 'work-visuals/operations-v1.webp'],
]) {
