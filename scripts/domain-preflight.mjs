...
export const preflightChecks = Object.freeze([
  ...
  {path:'/data-core/assets/mode-counseling-photo-v1.webp',status:200,type:'image/webp'},
  {path:'/data-core/assets/mode-work-photo-v1.webp',status:200,type:'image/webp'},
