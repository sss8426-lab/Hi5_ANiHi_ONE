...
try {
  ...
  await page.waitForFunction(()=>document.querySelector('.cig-feedback')?.hidden&&document.querySelector('.cig-image')?.naturalWidth);assert.equal(requests.get('/api/data-core/files/synthetic-0'),count);
